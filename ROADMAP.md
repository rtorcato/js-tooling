...
`@rtorcato/repo-tooling` is a single-package TypeScript/JavaScript tooling
...
**[GitHub milestones](https://github.com/rtorcato/repo-tooling/milestones)** —
...
- **Supply-chain security** — Dependabot + CodeQL scaffolding, and
  [GitHub settings sync](https://github.com/rtorcato/repo-tooling/milestone/1)
  (branch protection, merge settings, workflow permissions).
- **[Preset backlog](https://github.com/rtorcato/repo-tooling/milestone/6)** —
...
- **[Hardening — trustworthy generated output](https://github.com/rtorcato/repo-tooling/milestone/3)**
  — every scaffolded project passes its own `doctor`/lint/build out of the box.
- **[Docs & docs-site](https://github.com/rtorcato/repo-tooling/milestone/5)** —
...
- **[Repo & release hygiene](https://github.com/rtorcato/repo-tooling/milestone/4)**
  — release docs, OIDC trusted publishing, and the Dependabot grouping/auto-merge
  strategy.
- **[Multi-language support](https://github.com/rtorcato/repo-tooling/milestone/2)**
  — a language-agnostic base with per-language modules (umbrella
  [#139](https://github.com/rtorcato/repo-tooling/issues/139)); the JS core hardens
  first.

## Exploring

- OIDC trusted publishing to retire the long-lived `NPM_TOKEN`
  ([#201](https://github.com/rtorcato/repo-tooling/issues/201)).
- Dependabot grouping + auto-merge + major-triage
  ([#111](https://github.com/rtorcato/repo-tooling/issues/111)).
- Extracting more shared tooling out of the consumer repos
  ([#161](https://github.com/rtorcato/repo-tooling/issues/161)).

## Versioning & stability

The public surface is the **CLI** (`setup`/`doctor`/`fix`/`list`/`copy` and their
JSON contracts) and the **preset exports** (`@rtorcato/repo-tooling/*`). Both follow
