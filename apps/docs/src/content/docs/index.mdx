...
<CardGrid>
  ...
  <Card title="Supply-chain security" icon="seti:lock">
    Dependabot for weekly dep updates and CodeQL for security scanning, scaffolded as opt-in workflows.
  </Card>
  <Card title="CLI" icon="puzzle">
    `setup` wizard for new projects, `doctor` drift checker, `fix` for incremental upgrades, and `copy` for individual files.
  </Card>
</CardGrid>
